...
// Обработчики событий для работы с персонажем игрока
currentWisardCoat.addEventListener('click', function () {
  currentWisardCoatInput.value = findNextInArray(currentWisardCoatInput, WIZARD_COAT_COLORS)
  currentWisardCoat.style.fill = currentWisardCoatInput.value
})

currentWisardEyes.addEventListener('click', function () {
  currentWisardEyesInput.value = findNextInArray(currentWisardEyesInput, WIZARD_EYES_COLORS)
  currentWisardEyes.style.fill = currentWisardEyesInput.value
})

fireball.addEventListener('click', function () {
  fireballInput.value = findNextInArray(fireballInput, WIZARD_FIREBALLS_COLORS)
