...
// Глобальные константы
  ...
  function createWizardMock () {
    return {
      name: `${window.util.getRandomFromArray(WIZARD_FIRST_NAMES)} ${window.util.getRandomFromArray(WIZARD_SECOND_NAMES)}`,
      coatColor: window.util.getRandomFromArray(WIZARD_COAT_COLORS),
      eyesColor: window.util.getRandomFromArray(WIZARD_EYES_COLORS)
    }
  }
  ...
  window.setup = {
    ...
    renderWizardsList,
    showWizards,
    wizardsQuantity: WIZARDS_QUANTITY
  }
})()
